...
<div class = "grid grid cols-3 md:grid-cols-3 sm: grid-cols-1">
    <div class = "my-5 rounded-xl text-white bg-secondary mx-5">
        <div class = "p-5 flex flex-col">
            ...
            <a href="https://github.com/ornobdoorknob/resume-projects/tree/main/SearchAndSort" class = "transition-all duration-500 text-center py-2 rounded-lg bg-primary hover:bg-white hover:text-black">View code</a>
        </div>
    </div>
    <div class = "my-5 rounded-xl text-white bg-secondary mx-5">
        <div class = "p-5 flex flex-col">
            ...
            <a href="https://github.com/ornobdoorknob/resume-projects/tree/main/PhoneNumberFormatter" class = "transition-all duration-500 text-center py-2 rounded-lg bg-primary hover:bg-white hover:text-black">View code</a>
        </div>
    </div>
    <div class = "my-5 rounded-xl text-white bg-secondary mx-5 border-white">
        <div class = "p-5 flex flex-col">
            ...
            <a href="https://github.com/ornobdoorknob/website" class = "transition-all duration-500 text-center py-2 rounded-lg bg-primary hover:bg-white hover:text-black">View code</a>
        </div>
    </div>
</div>
    </div>
