            ...
            <div class="sm:flex sm:items-center sm:justify-between font-oswald">
                ...
                <ul class="flex flex-wrap items-center mb-6 text-sm sm:mb-0 text-gray-500">
                    <li class="px-3 font-poppins">
                        <a href="https://www.linkedin.com/in/tahmid-khan-arnab/" class="mr-4 md:mr-6 hover:text-white"><img src="images/linkedin.png" className='h-6'></img>Linkedin</a>
                    </li>
                    <li class="px-3 font-poppins">
                        <a href="https://github.com/ornobdoorknob" class="mr-4 md:mr-6 hover:text-white"><img src="images/github.png" className='h-6'></img>Github</a>
                    </li>
                </ul>
            </div>
