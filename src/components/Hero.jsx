    ...
    return (
        <div name="top" class="w-full bg-center flex items-center h-screen place-content-center bg-primary bg-contain bg-[length:45px_50px] bg-[url('hideout.svg')] bg-fixed">
            <div class="text-white py-20 px-10 drop-shadow-4xl md:text-left text-center">
                ...
                <div class="font-oswald text-4xl md:text-8xl font-extrabold md:pb-5 pb-2 whitespace-nowrap text-transparent bg-fixed bg-clip-text bg-gradient-to-b from-rose-400 via-fuchsia-500 to-indigo-500">Tahmid Khan Arnab</div>
                ...
                <div class="py-5 float-left w-full align-center">
                    <a href='#skills'>
                        <button class="relative inline-flex items-center justify-center mb-2 mr-2 overflow-hidden text-lg font-medium text-white group bg-black">
                            <span class="bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 relative px-1 py-1 transition-all ease-in duration-300 bg-black"><div class="bg-primary transition-all duration-300 h-full p-1 hover:px-5">
                                Skills</div>
                            </span>
                        </button>
                    </a>
