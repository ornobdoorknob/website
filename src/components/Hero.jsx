    ...
    return (
        <div name="top" class="w-full flex items-center h-screen place-content-center">
            <div class="text-white py-20 px-10 drop-shadow-4xl md:text-left text-center">
                <img src="instahd.png" className='py-2 object-center mx-auto md:mx-0 transition-all duration-300 h-60 md:h-40' />
                ...
                <a href='#skills'><img src="down.svg" class="h-45 pt-10 mx-auto hover:opacity-70 animate-bounce"></img></a>
            </div>  
        </div>
    )
}
